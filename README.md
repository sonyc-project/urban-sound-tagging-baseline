...
$ python evaluate_predictions.py ../output/baseline_fine/*/output_mean.csv ../sonyc-ust/annotations.csv ../sonyc-ust/dcase-ust-taxonomy.yaml
# Train coarse-level model and produce predictions
$ python classify.py ../sonyc-ust/annotations.csv ../sonyc-ust/dcase-ust-taxonomy.yaml ../features/vggish ../output baseline_coarse --label_mode coarse
# Evaluate model based on AUPRC metrics
$ python evaluate_predictions.py ../output/baseline_coarse/*/output_mean.csv ../sonyc-ust/annotations.csv ../sonyc-ust/dcase-ust-taxonomy.yaml
